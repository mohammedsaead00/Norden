...
{
    /// <inheritdoc />
    public partial class UpdateDatabaseSchemaToNordenSpec : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleId = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedSize = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_CartId_ProductId_SelectedColor_SelectedSize",
                table: "CartItems",
                columns: new[] { "CartId", "ProductId", "SelectedColor", "SelectedSize" },
                unique: true,
                filter: "[SelectedColor] IS NOT NULL AND [SelectedSize] IS NOT NULL");
